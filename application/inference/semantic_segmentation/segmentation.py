...
class YOLOv8Seg:
    ...
    def __call__(self, im0, conf_threshold=0.4, iou_threshold=0.45, nm=32):
        ...
        return boxes, [item.tolist() for item in segments], masks
...
if __name__ == "__main__":
    pt_path = "/home/mading/object_detection/cv_inference_scheduler/weights/yolov8s-seg.pt"
    ...
    # Build model
    model = YOLOv8Seg(model, data_config="/home/mading/object_detection/cv_inference_scheduler/yml/coco.yaml")
